...
Axiom path_dep_nonneg : forall (v1:vertex) (v2:vertex) (n:Z) (d:Z), (path v1
  v2 n d) -> (0%Z <= d)%Z.

Axiom path_in_vertices : forall (v1:vertex) (v2:vertex) (n:Z) (d:Z), (mem v1
  vertices) -> ((path v1 v2 n d) -> (mem v2 vertices)).

Axiom reach_empty : forall (v1:vertex) (v2:vertex) (n:Z), ((mem v1
  vertices) /\ (mem v2 vertices)) -> ((path v1 v2 n 0%Z) -> ((v1 = v2) /\
  (n = 0%Z))).
